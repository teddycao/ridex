...
var procuct_Combo111 = new Ext.data.JsonStore({
 ...
 var fp = new Ext.FormPanel({
		...
		,{
            ...
            id: 'form-file',
            emptyText: 'Excel格式文件,例如:1380917xxxx[201109]_语音_清单.xls',
            fieldLabel: '导入文件',
            name: 'file',
			...
			{ boxLabel: '勾选', name: 'isdouble', id: 'isdouble', inputValue: 'true', xtype: 'checkbox', checked: false,labelStyle: 'font-weight:bold;' }
		],
        buttons: [{
            text: ' &nbsp;导入并试算 ',
			 scale: 'large',
	                    ...
	                    success: function(form, action){
							...
							if(!imortRestData.success){
							 ...
							 //Ext.MessageBox.alert('操作成功','手机号码:' + imortRestData.msisdn +'  通话日期:'+imortRestData.billdate
								//+ '<br>的语音清单已经成功导入!');
							 keepOptBtnLive();
							 confirmSendback(Ext.getCmp("isdouble").getValue(),Ext.getCmp("product_id").getValue(),Ext.getCmp("product_vid").getValue());
	                    },
