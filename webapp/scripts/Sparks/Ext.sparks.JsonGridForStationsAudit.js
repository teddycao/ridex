 ...
 * @param config    需要的配置{}
 */
Ext.sparks.JsonGridForStationsAudit = Ext.extend(Ext.grid.GridPanel, {
    loadMask: true,
    stripeRows: true,
	postParam:{},
    // 初始化
    initComponent: function() {
        ...
        Ext.sparks.JsonGridForStationsAudit.superclass.initComponent.call(this);
    ...
    buildToolbar: function() {
        ...
        this.tbar = new Ext.Toolbar([{
            ...
            iconCls : 'audit',
            tooltip : '审批',
            handler : this.audit.createDelegate(this)
        }]);
   ...
   getSelectedParams : function(params) {
    ...
    edit : function() {
        if (!this.dialog) {
           this.createDialog(formEditConfig);
        }
