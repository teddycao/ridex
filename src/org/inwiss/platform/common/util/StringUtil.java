 ...
 * @version $Revision: 1.28 $ $Date: 2008/08/01 15:50:16 $
 */
public class StringUtil {
	 ...
	 * @param model Map of pairs <code>variable -&gt; value</code>.
	 * @param exceptions set of exceptions names
     * @return Map with encoded string values
	 */
     ...
     * component is corresponding value.
     *
     ...
     */
    public static Map stringToMap(String str, String outerRegex,
                                  String innerRegex, boolean trimOuter,
