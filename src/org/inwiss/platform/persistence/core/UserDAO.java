...
public interface UserDAO extends DAO {
	...
	/**
	 * Creates new user cookie
	 *
	 * @param userCookie Value object that represents what userCookie must be created
     * @param user User for which cookie is created
     * @return cookie ID
	 */
	public Long createUserCookie(UserCookie userCookie, User user);

	/**
	 * Retrieves userCookie with specified ID
	 *
	 * @param cookieId ID to search by
	 * @return UserCookie or null if no user cookie with specified ID exists in database
	 */
	public UserCookie retrieveUserCookie(String cookieId);

	/**
	 * Deletes all cookies of user with specified name
	 *
	 * @param userName Name of userCookie to delete
	 */
