...
public class ExcelInputField implements Cloneable
{
	...
	public ExcelInputField(String fieldname, int position, int length)
	{
		this.name      = fieldname;
		this.length         = length;
		this.type           = Consts.TYPE_STRING;
		this.format         = "";
		this.trimtype       = ExcelImportMeta.TYPE_TRIM_NONE;
		this.groupSymbol   = "";
		this.decimalSymbol = "";
		this.currencySymbol= "";
		this.precision      = -1;
	...
	{
		return ExcelImportMeta.getTrimTypeCode(trimtype);
	}
	...
	{
		return name+":"+getName()+"("+length+","+precision+")";
	}
}
