...
/**
 * 处理不大于（小于或等于）的DataFilter实现类。
 * 
 * @author <a href="mailto:ljglory@126.com">Lujie</a>
 */
public class NotGreaterThanFilter extends DataFilterSupport implements DataFilter
{
    private boolean stringType;
    
    private DataFilter chainedFilter;
    
    public NotGreaterThanFilter(){}
    
    public NotGreaterThanFilter(String colName, String colValue, boolean stringType)
    {
    ...
    public NotGreaterThanFilter(String colName, String colValue, boolean stringType, DataFilter chainedFilter)
    {
        this.setColName(colName);
        this.setColValue(colValue);
        this.stringType = stringType;
